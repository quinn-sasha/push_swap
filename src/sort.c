...
/*   Updated: 2025/08/27 08:34:16 by squinn           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_three_elements(t_stack *stack1)
{
	...
	max_index = get_max_index(stack1);
 ...
 */
void	transfer_all_items_to_stack2(t_stack *stack1, t_stack *stack2,
		int chunk_size)
{
	int	min_index;
...
{
	int	position;
	int	num_left_rotations;
	int	num_right_rotations;
	int	direction;
	...
	while (stack2->size > 0)
	{
		...
		position = get_max_index_position(stack2);
		num_left_rotations = position;
		num_right_rotations = stack2->size - num_left_rotations;
