...
void				pop_stack1_and_push_stack2(t_stack *stack1,
						t_stack *stack2);
void				pop_stack2_and_push_stack1(t_stack *stack1,
						t_stack *stack2);
// sort.c
void				sort_three_elements(t_stack *stack1);
void				sort_less_than_five_elements(t_stack *stack1,
						t_stack *stack2);
void				transfer_all_items_to_stack2(t_stack *stack1,
						t_stack *stack2, int chunk_size);
void				put_back_all_items_to_stack1(t_stack *stack1,
						t_stack *stack2);
void				sort(t_stack *stack1, t_stack *stack2);
// initialize_stack.c
void				initialize_nodes(t_node *nodes, int size,
						char **input_nums);
void				initialize_stack1(t_stack *stack, int size,
						char **input_nums);
